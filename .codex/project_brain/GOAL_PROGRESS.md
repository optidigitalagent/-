...
- [x] Two-mailbox role model selected
- [x] Primary Freelancehunt mailbox selected outside the public repository
...
- [ ] Enable security/recovery for both mailboxes
- [ ] Connect both mailboxes through Gmail OAuth or approved forwarding
- [ ] Register/use one truthful Freelancehunt account through an eligible legal owner/format
- [ ] Record any platform-support response that affects account/team operation

## Stage 1 entry criteria

Stage 1 begins when the repository brain is approved, account/email roles are operational, and the lawful Freelancehunt account path is recorded.
